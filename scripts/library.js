...
const wallets = {
    ...
    brianKey: client.wallet(new MnemonicKey({
        mnemonic: "blind aware afraid inspire story giraffe decline chronic emerge cactus category rack farm invite myth eager similar that chef physical pig dry fit ball",
    }))
};
